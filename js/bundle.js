...
function slider(_ref) {
  ...
  if (slides.length < 10) {
    totalIndex.textContent = "0".concat(slides.length);
    currentIndex.textContent = "0".concat(currentSlide);
  } else {
  ...
  var carousel = document.querySelector('.offer__slider-wrapper');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2020-10-10');
